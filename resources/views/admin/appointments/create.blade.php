...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
			...
			<p class="total_time">
				<strong>Total time: <span id="time">0</span> hour(s)</strong>
				<input type="hidden" id="time_spent" name="time_spent" value="">
			</p>
			<p class="total_price">
				<strong>Total price: $<span id="price_total">0</span></strong>
				<input type="hidden" id="total_amt" name="total_amt" value="">
				<input type="hidden" id="perhour" name="perhour" value="">
			</p>
			</div>
            <div class="row">
                <div class="col-xs-12 form-group">
...
@section('javascript')
	...
	<script>
		...
		function CountPrice() {
			...
			$("#total_amt").val(price*total_hours);
			$("#perhour").val(price);
			$("#time").html(total_hours);
			$("#time_spent").val(total_hours);
